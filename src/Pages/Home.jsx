...
const Home = () => {
    ...
    const { refetch: getUserFiles, data: userFileList, error } = useReadContract({
        abi: backendContractAbi,
        address: backendContractAddress,
    ...
    if (!isConnected) {
        return (
            <div className=" min-h-screen p-4 files shadow-2xl  ">
               <img src="/logo-dark.svg" alt=""  className="w-[80px] "
               />
                        ...
                        <tr key={index} className={index % 2 === 0 ? 'bg-gray-800' : 'bg-gray-900'}>
                            ...
                            <td className="px-4 py-2 text-white">
                                <div className="flex mx-2 space-x-2">
                                    ...
                                    <button onClick={() => starFileHandler(item)}><HiStar /></button>
